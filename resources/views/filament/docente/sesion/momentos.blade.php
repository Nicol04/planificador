    ...
    <div class="bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen py-8 px-4">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-slate-600 text-sm">Gestión de Momentos</p>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-5 gap-6">
                ...
                <div class="lg:col-span-2">
                    <div class="bg-white rounded-lg shadow-lg p-6 border-t-4 border-blue-600">
                        ...
                        <p class="text-sm text-slate-500 mb-6">Datos brindados de la sesión</p>
                        ...
                        <div class="space-y-5">
                            ...
                            <div>
                                ...
                                <textarea
                                    ...
                                    rows="3" placeholder="Describa el propósito general de la sesión educativa..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    class="w-full border border-slate-300 rounded-md px-4 py-2.5 text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
                                    rows="3" placeholder="Describa los criterios de evaluación que se aplicarán..."></textarea>
                            </div>
                            ...
                            <div>
                                ...
                                <textarea
                                    class="w-full border border-slate-300 rounded-md px-4 py-2.5 text-slate-800 focus:ring-2 focus:ring-blue-500 focus:border-transparent transition resize-none"
                                    rows="3" placeholder="Describa las evidencias que demostrarán el aprendizaje..."></textarea>
                            </div>
