<x-filament-panels::page>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div>
                    ...
                    <x-filament::input.wrapper>
                        <x-filament::input
                            type="search"
                            placeholder="Nombre, situación significativa..."
                ...
                <div>
                    ...
                    <x-filament::input.wrapper>
                        <x-filament::input.select wire:model.live="filterGrado">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6" wire:loading.class="opacity-50">
            @forelse($this->getFilteredUnidades() as $unidad)
                <div class="bg-white rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 dark:bg-gray-800 border border-gray-100 dark:border-gray-700 overflow-hidden group">
                    {{-- Estado y Grado --}}
                    <div class="p-4 bg-gradient-to-r from-blue-50 to-indigo-50 dark:from-gray-700 dark:to-gray-600 border-b">
                        <div class="flex justify-between items-center">
                            <span class="inline-flex items-center px-3 py-1 rounded-full text-xs font-semibold {{ $this->getEstadoColor($unidad) }}">
                                {{ $this->getEstadoTexto($unidad) }}
                            </span>
                            <span class="bg-white dark:bg-gray-800 px-3 py-1 rounded-full text-sm font-medium text-gray-600 dark:text-gray-300 shadow-sm">
                                {{ $unidad->grado }}
                            </span>
                        </div>
                    </div>
                    ...
                    <div class="p-6">
                        ...
                        <div class="space-y-3 mb-4">
                            ...
                            <div class="flex items-center text-sm text-gray-600 dark:text-gray-400">
                                ...
                                <span class="font-medium">{{ $unidad->fecha_inicio->diffInDays($unidad->fecha_fin) + 1 }} días de duración</span>
                            </div>
                        ...
                        <div class="flex flex-wrap gap-2">
                            ...
                            <x-filament::button 
                                href="{{ route('filament.docente.resources.unidads.edit', $unidad) }}"
                                color="primary"
                                size="sm"
            ...
            @empty
                ...
                <div class="col-span-full">
                    <div class="text-center py-16 bg-white dark:bg-gray-800 rounded-xl border-2 border-dashed border-gray-300 dark:border-gray-600">
                        ...
                        <x-filament::button 
                            href="{{ route('filament.docente.resources.unidads.create') }}"
    ...
    <div id="modalPrevia" style="display: none; position: fixed; top: 0; left: 0; width: 100%; height: 100%; background: rgba(0,0,0,0.5); z-index: 9999; justify-content: center; align-items: center;">
    ...
    <script>
        ...
        function confirmarEliminacion(unidadId, nombreUnidad) {
            if (typeof Swal !== 'undefined') {
                ...
                // Fallback sin SweetAlert
                if (confirm(`⚠️ ¿Estás seguro de que quieres eliminar "${nombreUnidad}"? Esta acción no se puede deshacer.`)) {
